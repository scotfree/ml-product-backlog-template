...
Feeds Card 08-monitoring-maintenance/02 (what metrics to collect) and Card 07-documentation/02 (decisions log).

## Definition of Done

`docs/failure-modes.md`: table of failure mode, symptom, detection idea, response idea. At least 10 entries.

## Demo

Walk through the top three; explain how you'd catch them.
...
~1 day — best done as a whole-team session.
