...
- Modeling (04-iterate) consumes conclusions as input for the next iteration.
- Documentation (02-decisions-log) captures why choices were made.

## Definition of Done

`notebooks/error-analysis/<task>.ipynb` with 3–5 identified failure modes per task, each with example images and a hypothesis.

## Demo

Walk through 3 pest misclassifications; explain what's happening (usually: rare class, occlusion, or lab-vs-field domain shift).
