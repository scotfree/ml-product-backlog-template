...
- Any future contributor and any portfolio reviewer.
- Also the hand-off test (Card 05-product-analysis/03) uses it as source of truth.

## Definition of Done

Someone outside the team (test with a student from another team — Data A or Cloud) follows the README on a clean laptop and reproduces a training run without asking questions.

## Demo

Have that outside student show what they did in 3 minutes.
...
~1 day to write, plus a round of fixes after the outside test.
