...
- Modeling needs to know what data is available before choosing an architecture.
- Cloud (Kayvan) needs to know about any license constraints that propagate to AgCloud.

## Definition of Done

`docs/datasets.md` listing candidates per task with license, size, source URL, and one-line "why this / why not". Winner marked per task.

## Demo

Present the shortlist per task; call out any license landmines.
